...
class DDPG(object):
    def __init__(self, state_dim, action_dim, max_action, buffer_capacity):
    ...
    def select_action(self, state):
        state = torch.squeeze(torch.FloatTensor(state.reshape(1, -1))).to(device)
